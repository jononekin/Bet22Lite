...
public class MugimenduakBistaratuGUI extends JFrame {
	...
	private void jbInit() {
		...
		JScrollPane scrollBar_3;
		JScrollPane scrollBar_2;
		JList<Transaction> list_1;
		JList<Transaction> list;
		JScrollPane scrollBar_1;
